...
class StatePanel {
  ...
  StatePanel() {
    ...
    column.add(Utils.labelComponent("Available Millis:", availableTimePanel.panel));
    column.add(Utils.labelComponent("Sample Period:", sampleRatePanel.panel));

    column.add(Utils.labelComponent("JPen Version:", new JLabel(PenManager.getJPenFullVersion())));
