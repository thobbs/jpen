...
public final class WintabAccess {
   ...
   * @param cellIndex
   * @param valueIndex
   * @return an array of 4 ints, the min, max, unit type (TU_NONE, TU_INCHES, etc.), and unit
   *     resolution
   */
  ...
  /**
   * @param enabled If <code>true</code> then movement on Wintab devices cause movement on the
   *     system pointer. The default value is <code>true</code>.
   */
