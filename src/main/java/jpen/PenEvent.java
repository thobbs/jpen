...
public abstract class PenEvent implements java.io.Serializable {
  ...
  static final class Dummy extends PenEvent {
    Dummy() {
      super(null, (byte) 0, 0);
    }
   ...
   * @throws IllegalStateException if the {@link #pen} is null. {@code pen} is null after
   *     deserialization.
   */
  ...
  /**
   * @return The timestamp in milliseconds of when this event ocurred in the {@link PenDevice}. The
   *     value returned was measured since some fixed but arbitrary time imposed by the {@link
   *     PenDevice}.
   * @see #getDeviceId()
   * @see #getTime()
   */
